...
{
	std::ifstream reader("E:\\weightsandbiases\\WeightsFC1.txt");
	float temp;
	std::vector<std::vector<float>> weights;
	for (int i = 0; i < inputsize; i++)
	{
...
{
	std::ifstream reader("E:\\weightsandbiases\\BiasFC1.txt");
	float temp;
...
{
	std::ofstream writer("WeightsFC1.txt");
...
{
	std::ofstream writer("BiasFC1.txt");
