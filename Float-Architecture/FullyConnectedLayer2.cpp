...
#define NEXTPORT 13540
#define OUTNEURON 256
#define LR 0.0001
#define ALPHA 0
...
{
	std::ifstream reader("E:\\weightsandbiases\\WeightsFC2.txt");
	float temp;
	std::vector<std::vector<float>> weights;
	for (int i = 0; i < inputsize; i++)
	{
...
{
	std::ifstream reader("E:\\weightsandbiases\\BiasFC2.txt");
	float temp;
...
{
	std::ofstream writer("WeightsFC2.txt");
...
{
	std::ofstream writer("BiasFC2.txt");
